...
function mappress_scripts() {
	...
	wp_enqueue_script('mappress', get_template_directory_uri() . '/js/mappress.js', array('mapbox-js', 'underscore', 'jquery'), '0.0.8.22');
	...
	wp_enqueue_script('mappress.filterLayers', get_template_directory_uri() . '/js/mappress.filterLayers.js', array('mappress', 'underscore'), '0.0.6');
	wp_enqueue_script('mappress.groups', get_template_directory_uri() . '/js/mappress.groups.js', array('mappress', 'underscore'), '0.0.5.1');
	wp_enqueue_script('mappress.markers', get_template_directory_uri() . '/js/mappress.markers.js', array('mappress', 'underscore'), '0.0.4.16');
	...
	wp_localize_script('mappress.markers', 'mappress_markers', array(
		...
		'stories_label' => __('stories', 'mappress'),
		'home' => is_front_page(),
		'copy_embed_label' => __('Copy the embed code', 'mappress'),
		'share_label' => __('Share this', 'mappress'),
		'site_url' => home_url('/'),
		'read_more_label' => __('Read', 'mappress')
	));
}
