...
class JEO_Range_Slider {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script('jeo-range-slider', get_template_directory_uri() . '/inc/js/range-slider.js', array('range-slider', 'jeo.markers', 'jeo.groups', 'underscore', 'moment-js'), '0.0.1');
