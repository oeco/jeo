...
function mapbox_metabox_init() {
	...
	wp_enqueue_script('mapbox-metabox', MAPPRESS_PATH . '/metaboxes/mapbox/mapbox.js', array('jquery', 'mappress', 'jquery-ui-sortable'), '0.4.14');
	wp_enqueue_style('mapbox-metabox', MAPPRESS_PATH . '/metaboxes/mapbox/mapbox.css', array(), '0.0.9.1');
