...
function geocoding_init() {
	wp_enqueue_script('geocoding-metabox', get_template_directory_uri() . '/metaboxes/geocode/geocode-osm.js', array('jquery', 'mapbox-js'), '0.0.3.2');
}
...
function geocoding_inner_custom_box($post) {
	...
	<div id="geolocate_canvas" style="width:550px;height:350px"></div>
